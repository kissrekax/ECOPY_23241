...
food2=change_price_to_float(food)
print(food2.head())
#3
...
print(unique_items_over_ten_dollars(food2))
#8
def items_starting_with_s(input_df):
    ...
    return result_df
print(items_starting_with_s(food2))
#9
